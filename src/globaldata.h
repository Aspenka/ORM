...
/*=============================================================
 * Пространство имен globalData содержит переменные и фкнции,
 * использование которых происходит во многих модулях программы
 * и приводит к избыточному дублированию кода.
=============================================================*/
...
//функция, возвращающая результат подключения к БД
...
//отображение сообщения об ошибке в зависимости от ее кода
